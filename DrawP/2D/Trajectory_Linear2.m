function [q,z_1,z_2,y_n,g_x] = Trajectory_Linear2(q_j_11,q_j_12,z_1j,z_2j,tau_j,eta_j,N,P_s1,P_u1)
...
%     end
   ...
   subject to   
    ...
    q(:,1)==q_I1; q(:,N+1)==q_F1;        
    H^2 +  sum( (q(:,ii+1)-w_d1).^2 ) <= (z_2).^(2/alpha); 
    H^2 +  sum( (q(:,ii+1)-w_s1).^2,1 ) <= (z_1).^(2/alpha);    
...
%     Theta_2(1, :) >= 0;
    ...
    for n=1:N
        ...
        -2.*D.*sum( (q_j_12(:,n)-q_j_11(:,n)).^2 )+ 4.*D.*(q_j_12(:,n)-q_j_11(:,n))'*(q(:,n+1)-q(:,n));
