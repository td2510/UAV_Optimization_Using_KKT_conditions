...
%         P_1.*y_j+P_p.* pow_pos(norm(q_j_12 - q_j_11),1.5)./(delta_t.^2);
   E_fly = zeros(1,N);
    for n1=1:N
        E_fly(1,n1) = P_0.*(delta_t + B.*sum((q_j_1(:,n1+1)-q_j_1(:,n1)).^2) ) + ...
        P_1.*y_j(:,n1)+P_p.* pow_pos(norm(q_j_1(:,n1+1)-q_j_1(:,n1)),1.5)./(delta_t.^2);
    end
   %% Maximization %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   minimize (-g_x)  
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
