...
%         R_d = log2(1+ Theta.*(eta_j.*omega_0.*P_s1+P_u1*(ceil(sigma)).*(sum( (q_j_22 - w_s).^2 )).^(alpha/2))...        
%         ./( sum( (q_j_22 - w_s).^2 )).^(alpha/2) ./( sum( (q_j_22 - w_d).^2 )).^(alpha/2) );
        R_d = log2(1+ Theta.*(eta_j.*omega_0.*P_s1+P_u1.*(1+ceil(sigma)).*( sum( (q_j_22 - w_s).^2 )).^(alpha/2))...
        ./( sum( (q_j_22 - w_s).^2 )).^(alpha/2) ./( sum( (q_j_22 - w_d).^2 )).^(alpha/2) );
